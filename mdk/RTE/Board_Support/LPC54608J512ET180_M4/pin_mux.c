...
pin_labels:
- {pin_num: H14, pin_signal: PIO2_27/LCD_VD(9)/FC9_SCK/FC3_SSEL2, label: P0_27, identifier: P0_27}
...
- pin_list:
  ...
  - {pin_num: H14, peripheral: GPIO, signal: 'PIO2, 27', pin_signal: PIO2_27/LCD_VD(9)/FC9_SCK/FC3_SSEL2, direction: OUTPUT}
...
void BOARD_InitPins(void)
{
    ...
    IOCON->PIO[0][15] = ((IOCON->PIO[0][15] &
                         ...
                         /* Selects pin function.: PORT015 (pin L4) is configured as EMC_WEN */
    ...
    IOCON->PIO[0][18] = ((IOCON->PIO[0][18] &
                         ...
                         /* Selects pin function.: PORT018 (pin C14) is configured as EMC_A(0) */
    ...
    IOCON->PIO[0][19] = ((IOCON->PIO[0][19] &
                         ...
                         /* Selects pin function.: PORT019 (pin C6) is configured as EMC_A(1) */
    ...
    IOCON->PIO[0][2] = ((IOCON->PIO[0][2] &
                        ...
                        /* Selects pin function.: PORT02 (pin E9) is configured as EMC_D(0) */
    ...
    IOCON->PIO[0][20] = ((IOCON->PIO[0][20] &
                         ...
                         /* Selects pin function.: PORT020 (pin D13) is configured as EMC_A(2) */
    ...
    IOCON->PIO[0][21] = ((IOCON->PIO[0][21] &
                         ...
                         /* Selects pin function.: PORT021 (pin C13) is configured as EMC_A(3) */
    ...
    IOCON->PIO[0][3] = ((IOCON->PIO[0][3] &
                        ...
                        /* Selects pin function.: PORT03 (pin A10) is configured as EMC_D(1) */
    ...
    IOCON->PIO[0][4] = ((IOCON->PIO[0][4] &
                        ...
                        /* Selects pin function.: PORT04 (pin C8) is configured as EMC_D(2) */
    ...
    IOCON->PIO[0][5] = ((IOCON->PIO[0][5] &
                        ...
                        /* Selects pin function.: PORT05 (pin E7) is configured as EMC_D(3) */
    ...
    IOCON->PIO[0][6] = ((IOCON->PIO[0][6] &
                        ...
                        /* Selects pin function.: PORT06 (pin A5) is configured as EMC_D(4) */
    ...
    IOCON->PIO[0][7] = ((IOCON->PIO[0][7] &
                        ...
                        /* Selects pin function.: PORT07 (pin H12) is configured as EMC_D(5) */
    ...
    IOCON->PIO[0][8] = ((IOCON->PIO[0][8] &
                        ...
                        /* Selects pin function.: PORT08 (pin H10) is configured as EMC_D(6) */
    ...
    IOCON->PIO[0][9] = ((IOCON->PIO[0][9] &
                        ...
                        /* Selects pin function.: PORT09 (pin G12) is configured as EMC_D(7) */
    ...
    IOCON->PIO[1][10] = ((IOCON->PIO[1][10] &
                         ...
                         /* Selects pin function.: PORT110 (pin N9) is configured as EMC_RASN */
    ...
    IOCON->PIO[1][11] = ((IOCON->PIO[1][11] &
                         ...
                         /* Selects pin function.: PORT111 (pin B4) is configured as EMC_CLK(0) */
    ...
    IOCON->PIO[1][12] = ((IOCON->PIO[1][12] &
                         ...
                         /* Selects pin function.: PORT112 (pin K9) is configured as EMC_DYCSN(0) */
    ...
    IOCON->PIO[1][13] = ((IOCON->PIO[1][13] &
                         ...
                         /* Selects pin function.: PORT113 (pin G10) is configured as EMC_DQM(0) */
    ...
    IOCON->PIO[1][14] = ((IOCON->PIO[1][14] &
                         ...
                         /* Selects pin function.: PORT114 (pin C12) is configured as EMC_DQM(1) */
    ...
    IOCON->PIO[1][15] = ((IOCON->PIO[1][15] &
                         ...
                         /* Selects pin function.: PORT115 (pin A11) is configured as EMC_CKE(0) */
    ...
    IOCON->PIO[1][16] = ((IOCON->PIO[1][16] &
                         ...
                         /* Selects pin function.: PORT116 (pin B7) is configured as EMC_A(10) */
    ...
    IOCON->PIO[1][19] = ((IOCON->PIO[1][19] &
                         ...
                         /* Selects pin function.: PORT119 (pin L1) is configured as EMC_D(8) */
    ...
    IOCON->PIO[1][20] = ((IOCON->PIO[1][20] &
                         ...
                         /* Selects pin function.: PORT120 (pin M1) is configured as EMC_D(9) */
    ...
    IOCON->PIO[1][21] = ((IOCON->PIO[1][21] &
                         ...
                         /* Selects pin function.: PORT121 (pin N8) is configured as EMC_D(10) */
    ...
    IOCON->PIO[1][23] = ((IOCON->PIO[1][23] &
                         ...
                         /* Selects pin function.: PORT123 (pin M10) is configured as EMC_A(11) */
    ...
    IOCON->PIO[1][24] = ((IOCON->PIO[1][24] &
                         ...
                         /* Selects pin function.: PORT124 (pin N14) is configured as EMC_A(12) */
    ...
    IOCON->PIO[1][25] = ((IOCON->PIO[1][25] &
                         ...
                         /* Selects pin function.: PORT125 (pin M12) is configured as EMC_A(13) */
    ...
    IOCON->PIO[1][26] = ((IOCON->PIO[1][26] &
                         ...
                         /* Selects pin function.: PORT126 (pin J10) is configured as EMC_A(8) */
    ...
    IOCON->PIO[1][27] = ((IOCON->PIO[1][27] &
                         ...
                         /* Selects pin function.: PORT127 (pin F10) is configured as EMC_A(9) */
    ...
    IOCON->PIO[1][28] = ((IOCON->PIO[1][28] &
                         ...
                         /* Selects pin function.: PORT128 (pin E12) is configured as EMC_D(12) */
    ...
    IOCON->PIO[1][29] = ((IOCON->PIO[1][29] &
                         ...
                         /* Selects pin function.: PORT129 (pin C11) is configured as EMC_D(13) */
    ...
    IOCON->PIO[1][30] = ((IOCON->PIO[1][30] &
                         ...
                         /* Selects pin function.: PORT130 (pin A8) is configured as EMC_D(14) */
    ...
    IOCON->PIO[1][31] = ((IOCON->PIO[1][31] &
                         ...
                         /* Selects pin function.: PORT131 (pin C5) is configured as EMC_D(15) */
    ...
    IOCON->PIO[1][4] = ((IOCON->PIO[1][4] &
                        ...
                        /* Selects pin function.: PORT14 (pin D4) is configured as EMC_D(11) */
    ...
    IOCON->PIO[1][5] = ((IOCON->PIO[1][5] &
                        ...
                        /* Selects pin function.: PORT15 (pin E4) is configured as EMC_A(4) */
    ...
    IOCON->PIO[1][6] = ((IOCON->PIO[1][6] &
                        ...
                        /* Selects pin function.: PORT16 (pin G4) is configured as EMC_A(5) */
    ...
    IOCON->PIO[1][7] = ((IOCON->PIO[1][7] &
                        ...
                        /* Selects pin function.: PORT17 (pin N1) is configured as EMC_A(6) */
    ...
    IOCON->PIO[1][8] = ((IOCON->PIO[1][8] &
                        ...
                        /* Selects pin function.: PORT18 (pin P8) is configured as EMC_A(7) */
    ...
    IOCON->PIO[1][9] = ((IOCON->PIO[1][9] &
                        ...
                        /* Selects pin function.: PORT19 (pin K6) is configured as EMC_CASN */
    ...
    IOCON->PIO[2][10] = ((IOCON->PIO[2][10] &
                         ...
                         /* Selects pin function.: PORT210 (pin P1) is configured as SD_CARD_DET_N */
    ...
    IOCON->PIO[2][11] = ((IOCON->PIO[2][11] &
                         ...
                         /* Selects pin function.: PORT211 (pin K3) is configured as LCD_PWR */
    ...
    IOCON->PIO[2][13] = ((IOCON->PIO[2][13] &
                         ...
                         /* Selects pin function.: PORT213 (pin P7) is configured as LCD_DCLK */
    ...
    IOCON->PIO[2][14] = ((IOCON->PIO[2][14] &
                         ...
                         /* Selects pin function.: PORT214 (pin L7) is configured as LCD_FP */
    ...
    IOCON->PIO[2][15] = ((IOCON->PIO[2][15] &
                         ...
                         /* Selects pin function.: PORT215 (pin M8) is configured as LCD_AC */
    ...
    IOCON->PIO[2][16] = ((IOCON->PIO[2][16] &
                         ...
                         /* Selects pin function.: PORT216 (pin L8) is configured as LCD_LP */
    ...
    IOCON->PIO[2][21] = ((IOCON->PIO[2][21] &
                         ...
                         /* Selects pin function.: PORT221 (pin L10) is configured as LCD_VD(3) */
    ...
    IOCON->PIO[2][22] = ((IOCON->PIO[2][22] &
                         ...
                         /* Selects pin function.: PORT222 (pin K10) is configured as LCD_VD(4) */
    ...
    IOCON->PIO[2][23] = ((IOCON->PIO[2][23] &
                         ...
                         /* Selects pin function.: PORT223 (pin M14) is configured as LCD_VD(5) */
    ...
    IOCON->PIO[2][24] = ((IOCON->PIO[2][24] &
                         ...
                         /* Selects pin function.: PORT224 (pin K14) is configured as LCD_VD(6) */
    ...
    IOCON->PIO[2][25] = ((IOCON->PIO[2][25] &
                         ...
                         /* Selects pin function.: PORT225 (pin J11) is configured as LCD_VD(7) */
    ...
    IOCON->PIO[2][27] = ((IOCON->PIO[2][27] &
                         ...
                         /* Selects pin function.: PORT227 (pin H14) is configured as PIO2_27 */
    ...
    IOCON->PIO[2][28] = ((IOCON->PIO[2][28] &
                         ...
                         /* Selects pin function.: PORT228 (pin G13) is configured as LCD_VD(10) */
    ...
    IOCON->PIO[2][29] = ((IOCON->PIO[2][29] &
                         ...
                         /* Selects pin function.: PORT229 (pin G11) is configured as LCD_VD(11) */
    ...
    IOCON->PIO[2][3] = ((IOCON->PIO[2][3] &
                        ...
                        /* Selects pin function.: PORT23 (pin B1) is configured as SD_CLK */
    ...
    IOCON->PIO[2][30] = ((IOCON->PIO[2][30] &
                         ...
                         /* Selects pin function.: PORT230 (pin F12) is configured as LCD_VD(12) */
    ...
    IOCON->PIO[2][31] = ((IOCON->PIO[2][31] &
                         ...
                         /* Selects pin function.: PORT231 (pin D14) is configured as LCD_VD(13) */
    ...
    IOCON->PIO[2][4] = ((IOCON->PIO[2][4] &
                        ...
                        /* Selects pin function.: PORT24 (pin D3) is configured as SD_CMD */
    ...
    IOCON->PIO[2][5] = ((IOCON->PIO[2][5] &
                        ...
                        /* Selects pin function.: PORT25 (pin C1) is configured as SD_POW_EN */
    ...
    IOCON->PIO[2][6] = ((IOCON->PIO[2][6] &
                        ...
                        /* Selects pin function.: PORT26 (pin F3) is configured as SD_D(0) */
    ...
    IOCON->PIO[2][7] = ((IOCON->PIO[2][7] &
                        ...
                        /* Selects pin function.: PORT27 (pin J2) is configured as SD_D(1) */
    ...
    IOCON->PIO[2][8] = ((IOCON->PIO[2][8] &
                        ...
                        /* Selects pin function.: PORT28 (pin F4) is configured as SD_D(2) */
    ...
    IOCON->PIO[2][9] = ((IOCON->PIO[2][9] &
                        ...
                        /* Selects pin function.: PORT29 (pin K2) is configured as SD_D(3) */
    ...
    IOCON->PIO[3][0] = ((IOCON->PIO[3][0] &
                        ...
                        /* Selects pin function.: PORT30 (pin D12) is configured as LCD_VD(14) */
    ...
    IOCON->PIO[3][1] = ((IOCON->PIO[3][1] &
                        ...
                        /* Selects pin function.: PORT31 (pin D11) is configured as LCD_VD(15) */
    ...
    IOCON->PIO[3][15] = ((IOCON->PIO[3][15] &
                         ...
                         /* Selects pin function.: PORT315 (pin D2) is configured as SD_WR_PRT */
    ...
    IOCON->PIO[3][23] = ((IOCON->PIO[3][23] &
                         ...
                         /* Selects pin function.: PORT323 (pin C2) is configured as FC2_CTS_SDA_SSEL0 */
    ...
    IOCON->PIO[3][24] = ((IOCON->PIO[3][24] &
                         ...
                         /* Selects pin function.: PORT324 (pin E2) is configured as FC2_RTS_SCL_SSEL1 */
    ...
    IOCON->PIO[3][25] = ((IOCON->PIO[3][25] &
                         ...
                         /* Selects pin function.: PORT325 (pin P9) is configured as EMC_A(14) */
    ...
    IOCON->PIO[3][5] = ((IOCON->PIO[3][5] &
                        ...
                        /* Selects pin function.: PORT35 (pin B10) is configured as LCD_VD(19) */
    ...
    IOCON->PIO[3][6] = ((IOCON->PIO[3][6] &
                        ...
                        /* Selects pin function.: PORT36 (pin C9) is configured as LCD_VD(20) */
    ...
    IOCON->PIO[3][7] = ((IOCON->PIO[3][7] &
                        ...
                        /* Selects pin function.: PORT37 (pin B8) is configured as LCD_VD(21) */
    ...
    IOCON->PIO[3][8] = ((IOCON->PIO[3][8] &
                        ...
                        /* Selects pin function.: PORT38 (pin A7) is configured as LCD_VD(22) */
    ...
    IOCON->PIO[3][9] = ((IOCON->PIO[3][9] &
                        ...
                        /* Selects pin function.: PORT39 (pin C7) is configured as LCD_VD(23) */
